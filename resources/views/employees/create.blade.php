...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['setting.employees.store']]) !!}
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="card card-info">
                ...
                <div class="card-body">
                        <div class="form-group">
                            {!! Form::label('job_id', trans('global.employee.fields.job').'*', ['class' => 'control-label']) !!}
                            {!! Form::select('job_id', $jobs, old('job_id'), ['class' => 'form-control select2', 'required' => '']) !!}
                            <p class="help-block"></p>

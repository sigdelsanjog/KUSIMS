<div class="sidebar">
   <nav class="sidebar-nav">
      <ul class="nav">
         ...
         <li class="nav-item nav-dropdown">
            <a class="nav-link nav-dropdown-toggle" href="#">
            <i class="nav-icon fas fa-envelope text-info"></i></i>Feedback</a>
            <ul class="nav-dropdown-items">
               @can('feedback_create')
               <li class="nav-item">
                  <a class="nav-link" href="{{ route('feedbacks.create') }}" target="_top">
                  <i class="nav-icon fas fa-comment"></i>Send</a>
               </li>
               @endcan
               ...
               @can('feedback_show')
               <li class="nav-item">
                  <a class="nav-link" href="{{ route('feedbacks.show') }}" target="_top">
                  <i class="nav-icon fas fa-envelope"></i>View</a>
               </li>
               @endcan
            </ul>
         </li>
